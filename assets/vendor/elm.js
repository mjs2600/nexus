...
var _user$project$Main$hackerNewsStoryView = function (story) {
	return A2(
					...
					_0: _elm_lang$html$Html$text(
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								' - ',
								_elm_lang$core$Basics$toString(story.score)))),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
};
var _user$project$Main$hackerNewsView = function (stories) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Hacker News Stories'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{ctor: '[]'},
					A2(_elm_lang$core$List$map, _user$project$Main$hackerNewsStoryView, stories)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$toDoListView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('To Do List'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$toDoListView(model),
				_1: {
					ctor: '::',
					_0: _user$project$Main$hackerNewsView(model.hackerNewsStories),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Main$channel = _saschatimme$elm_phoenix$Phoenix_Channel$init('news:lobby');
var _user$project$Main$wsServer = 'ws://localhost:4000/socket/websocket';
var _user$project$Main$socket = _saschatimme$elm_phoenix$Phoenix_Socket$init(_user$project$Main$wsServer);
...
var _user$project$Main$Story = F3(
	function (a, b, c) {
		return {title: a, url: b, score: c};
	});
var _user$project$Main$hackerNewsDecoder = A2(
	_elm_lang$core$Json_Decode$field,
	'stories',
...
var _user$project$Main$Model = function (a) {
	return {hackerNewsStories: a};
};
var _user$project$Main$NoOp = {ctor: 'NoOp'};
var _user$project$Main$News = function (a) {
	return {ctor: 'News', _0: a};
};
var _user$project$Main$decodeHackerNews = function (result) {
	var _p1 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Main$hackerNewsDecoder, result);
	if (_p1.ctor === 'Ok') {
		return _user$project$Main$News(_p1._0);
	} else {
...
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {
		hackerNewsStories: {ctor: '[]'}
	},
	_1: A2(
		_saschatimme$elm_phoenix$Phoenix$push,
		_user$project$Main$wsServer,
		A2(
			_saschatimme$elm_phoenix$Phoenix_Push$onOk,
			_user$project$Main$decodeHackerNews,
			A2(_saschatimme$elm_phoenix$Phoenix_Push$init, 'news:lobby', 'HackerNews')))
};
